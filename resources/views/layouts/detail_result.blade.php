...
<div class="detail_table">
    <table class="detail_inner">
        ...
        <tr>
            <th class="detail_header">試験結果</th>
            <td class="detail_data detail_border">{{ $details->result }}N/㎟</td>
            <th class="detail_header">試験者</th>
            <td class="detail_data indent">{{ $details->tester }}</td>
        </tr>
        <tr>
...
<div class="detail_back">
    <a href="#" onclick="history.back()"><i class="fa-solid fa-circle-arrow-left" style="padding-right: 1rem;"></i>戻る</a>
</div> 
