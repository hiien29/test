            ...
            <div class="table_outer">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a href="#" data-url="{{ route('result_delete', ['id'=>$param->id]) }}"  onclick="return Delete(this)"><i class="fa-regular fa-trash-can add2"></i></a></td>
            ...
            <div class="table_outer" style="width: 90%;margin-top: 2%;">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a href="#" data-url="{{ route('result_delete', ['id'=>$search->id]) }}"  onclick="return Delete(this)"><i class="fa-regular fa-trash-can add2"></i></a></td>
