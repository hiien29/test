            ...
            <div class="nottask table_outer" style="margin-top: 2%;" id="nottask">
                <table class="table">
                    ...
                    <tr>
                        ...
                        {{-- <td>
                            <form action="{{ route('task_delete', ['id'=>$nottask->id]) }}" method="GET" id="deleteForm">
                                <button type="button" onclick="return Delete()"><i class="fa-regular fa-trash-can add2"></i></button>
                            </form>
                        </td> --}}
                        <td><a href="#" data-url="{{ route('task_delete', ['id'=>$nottask->id]) }}"  onclick="return Delete(this)"><i class="fa-regular fa-trash-can add2"></i></a></td>
                    </tr>
                    @endforeach
                </table>
            </div>
        ...
        <div class="table_outer" style="margin-top: 2%;">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><a href="#" data-url="{{ route('task_delete', ['id'=>$param->id]) }}"  onclick="return Delete(this)"><i class="fa-regular fa-trash-can add2"></i></a></td>
                </tr>
                @endforeach
            </table>
        </div>
